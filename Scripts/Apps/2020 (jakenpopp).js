...
system42.on("splash:ready", function() {
	! function() {
		...
		function $rr() {
			$window({
				html: '<iframe width="560" height="315" src="https://web.archive.org/web/20200401232344/https://www.youtube.com/embed/dQw4w9WgXcQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
/*
     FILE ARCHIVED ON 23:23:44 Apr 01, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:29:49 Apr 28, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.118
  esindex: 0.016
  LoadShardBlock: 86.871 (3)
  PetaboxLoader3.datanode: 56.796 (4)
  PetaboxLoader3.resolve: 76.998 (2)
