...
socket.on('message',function(data){
	...
	if(data.msg.startsWith('quote')){
      	...
      	if(data.msg.startsWith('echo ')){
           ...
           sendMsg('ℹbot by: J.W.,\nCode by: HOST and J.W.\n 93!bot Copyright, 2017-2018. Discord: https://discord.gg/Ms4NFJb')
       }
