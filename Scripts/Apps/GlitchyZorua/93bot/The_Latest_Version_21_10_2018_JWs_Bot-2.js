...
// ..............|XHHHHHHHHHHHHHHHH:::    :HHHHHHHHHHHHHHn   -.___.-.___..DrS.'
        ...
        if(data.msg.startsWith('help')){
                socket.emit('message','❔ Need Help? help, quote, say, echo <text>, ae <js>, color <hex/Color name>, rename <name>, dice [number of sides], date, time, nlw, nickname, whoami, exe <93program>, b <text>, zalgo <text>, ascii <image Url>, 8ball [A question], 1ball [a queston], flip a coin, coin, LMoS, msgSent, MpM, MtM, joins, leaves, sleep\nRPG: Fish, Eat <food>, Drink <drink>, HP, Money, XP\nhi, hello, Trophy, OwO, lol, bot, ping, zoombot, nutnat, 3ggnluc, eas, kao, shrug, soni, fort, robl, frank, Thank You, Fuck You\niwc, nat, iwt, llc, fith, hos, 2gre, ndk, nut, nat, jbh, gre, con, gav, awc, lw, ns, faa\nabout, reload, 93!, prefix, figet spinner')
        }
